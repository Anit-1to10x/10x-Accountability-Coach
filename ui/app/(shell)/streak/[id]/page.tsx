...
import { formatDateSafe } from '@/lib/datetime'
...
export default function StreakDetailPage() {
  ...
  const daysRemaining = (() => {
    if (!challenge.targetDate || challenge.targetDate === 'dynamic' || challenge.targetDate === 'auto') return null
    if (challenge.targetDate === 'today') return 0
    const d = new Date(challenge.targetDate)
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium text-oa-text-primary">
                  {formatDateSafe(challenge.startDate)}
                </span>
              </div>
              {challenge.targetDate && (
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-oa-text-primary">
                    {formatDateSafe(challenge.targetDate)}
                  </span>
                </div>
              )}
